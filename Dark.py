    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UCIR5vSRc6TfdTVU0c65l5nA')
                time.sleep(1)
                menu()
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            ...
                            if zedd == '6':
                                os.system('rm -rf login.txt')
				os.system('xdg-open https://m.facebook.com/GocengCeban20')
                                keluar()
                            else:
                                if zedd == '0':
                                    keluar()
